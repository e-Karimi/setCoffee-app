    ...
    <footer className={styles.footer}>
      <main className="container">
        <section className={styles.descriptions}>
          ...
          <p className={styles.descriptions_title}>شرکت فنجان داغ خوارزمی، فروشگاه اینترنتی قهوه ست</p>

          <div className={styles.description}>
            <FaRegHeart style={{ fontSize: "2rem" }} />
            <p>تهران. شریف آباد . شهرک صنعتی خوارزمی فاز 2 . بلوار بهارستان. خیابان ماگنولیا بلوک آ117</p>
          </div>
          <div className={styles.description}>
            <FaRegHeart />
      ...
      <div className="container">
        <p className={styles.copyRight}>
          {" "}
          2023
          <MdOutlineCopyright /> تمام حقوق متعلق است به <strong>قهوه ست</strong> | طراحی و اجرا{" "}
